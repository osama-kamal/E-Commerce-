...
const slides = [
  { id:1, title:'🛍️ Shop Now', subtitle:'Discover Our Amazing Collection', image:'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&q=80&auto=format', cta:'Shop Now' },
  { id:2, title:'🔥 Hot Deals', subtitle:'Up to 50% Off on Selected Items', image:'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=1200&q=60&auto=format', cta:'See Deals' },
  { id:3, title:'👗 Fashion Week', subtitle:'Trending Styles for Every Occasion', image:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&q=60&auto=format', cta:'Explore' },
  { id:4, title:'💻 Tech Essentials', subtitle:'Latest Gadgets and Electronics', image:'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=1200&q=60&auto=format', cta:'Shop Tech' },
  { id:5, title:'🎁 Special Offers', subtitle:'Exclusive Deals Just for You', image:'https://images.unsplash.com/photo-1607082349566-187342175e2f?w=1200&q=60&auto=format', cta:'Claim Now' },
];
        ...
        {slides.map(sl => (
          <div key={sl.id} style={{ position:'relative', height:'100%', width:slideW, flexShrink:0 }}>
            <img
              src={sl.image}
              alt=""
              loading={sl.id === 1 ? 'eager' : 'lazy'}
              fetchPriority={sl.id === 1 ? 'high' : 'low'}
              decoding={sl.id === 1 ? 'sync' : 'async'}
